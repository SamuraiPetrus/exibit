...
vetor.x = '<div class="dimension"><span>X</span><input type="number" class="exibit-input half" name="exibit-vetor-dimensions_x" value="0" /></div>';
vetor.y = '<div class="dimension"><span>Y</span><input type="number" class="exibit-input half" name="exibit-vetor-dimensions_y" value="0" /></div>';
