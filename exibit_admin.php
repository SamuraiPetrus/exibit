  ...
  ?>
    ...
    <div class="exibit">
        <div class="settings">
            ...
            <button type="button" name="button" class="button tagadd"><input type="hidden" name="MAX_FILE_SIZE" value="30000" /><input id="exibit_preview" type="file" accept="image/*" class="upload_preview" name="exibit_vetor_preview" />Upload da imagem</button>
